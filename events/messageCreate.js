module.exports = (client, message) => {
    ...
    if (cmd && cmd.voiceChannel) {
        ...
        if (message.guild.me.voice.channel && message.member.voice.channel.id !== message.guild.me.voice.channel.id) return message.channel.send(`**You're Not In The Same Voice Channel ${message.author}... Try Again?** ❌`);
    }
